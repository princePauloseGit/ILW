codeunit 60044 "Barcode Management ROBO"
{
    ...
    var
        lrecTmpCode128: Record "Barcode 128/39 ROBO" temporary;
        lblnnumber: Boolean;
    ...
    var
        lrecTmpCode39: Record "Barcode 128/39 ROBO" temporary;
        lintBars: Integer;
        lintCheckDigit: Integer;
        lintConvInt: Integer;
        lintCount1: Integer;
    ...
    local procedure InitCode128(var precTmpCode128: Record "Barcode 128/39 ROBO" temporary)
    begin
        precTmpCode128.Init;
    ...
    local procedure InitCode39(var precTmpCode39: Record "Barcode 128/39 ROBO" temporary)
    begin
